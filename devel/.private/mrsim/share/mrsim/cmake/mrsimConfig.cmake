...
if("TRUE" STREQUAL "TRUE")
  set(mrsim_SOURCE_PREFIX /home/lattinone/catkin_ws/finalproject/src/mrsim)
  set(mrsim_DEVEL_PREFIX /home/lattinone/catkin_ws/finalproject/devel/.private/mrsim)
  set(mrsim_INSTALL_PREFIX "")
  set(mrsim_PREFIX ${mrsim_DEVEL_PREFIX})
else()
  set(mrsim_SOURCE_PREFIX "")
  set(mrsim_DEVEL_PREFIX "")
  set(mrsim_INSTALL_PREFIX /home/lattinone/catkin_ws/finalproject/install)
...
if(NOT "/home/lattinone/catkin_ws/finalproject/src/mrsim/include " STREQUAL " ")
  set(mrsim_INCLUDE_DIRS "")
  set(_include_dirs "/home/lattinone/catkin_ws/finalproject/src/mrsim/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'Andrea Ramella <ramella.1715191@studenti.uniroma1.it>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mrsim' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lattinone/catkin_ws/finalproject/src/mrsim/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lattinone/catkin_ws/finalproject/devel/.private/mrsim/lib;/home/lattinone/catkin_ws/finalproject/devel/lib;/opt/ros/noetic/lib)
